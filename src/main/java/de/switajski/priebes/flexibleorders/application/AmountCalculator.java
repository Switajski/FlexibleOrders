...
public class AmountCalculator {
    ...
    public static Amount sum(Collection<Amount> amounts) {
        ...
        for (Amount a : amounts) {
            if (currency == null) currency = a.getCurrency();
            else if (a.getCurrency() != currency) throw new IllegalArgumentException(
    ...
    public static List<Amount> getAmountsTimesQuantity(Collection<ReportItem> reportItems) {
        ...
        for (ReportItem ri : reportItems) {
            ...
            if (priceNet == null) throw new IllegalArgumentException(
