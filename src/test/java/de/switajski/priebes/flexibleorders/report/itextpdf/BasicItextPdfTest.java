...
public class BasicItextPdfTest {
	...
	private void addAddress(Document doc, String addressTo) throws DocumentException {
		...
		addresse.add("Maxstrasse 1");addresse.add(Chunk.NEWLINE);
		addresse.add("71636 Ludwigsburg");addresse.add(Chunk.NEWLINE);
		addresse.add("http://www.priebes.eu");addresse.add(Chunk.NEWLINE);
		
		doc.add(addresse);
	}

	private void insertLogo(Document document) throws BadElementException, MalformedURLException, DocumentException, IOException {
	...
	private void insertAdresse(Document doc, String address) throws MalformedURLException, IOException, DocumentException{
		Image img = Image.getInstance(LOGO);
	...
	private void insertTitle(Document doc, String title)throws MalformedURLException, IOException, DocumentException {
