...
privileged aspect PriebesJoomlaImporterServiceTest_Roo_IntegrationTest {
    
    declare @type: PriebesJoomlaImporterServiceTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: PriebesJoomlaImporterServiceTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: PriebesJoomlaImporterServiceTest: @Transactional;
    
    @Autowired
    OrderItemDataOnDemand PriebesJoomlaImporterServiceTest.dod;
    
    @Autowired
    OrderItemService PriebesJoomlaImporterServiceTest.orderItemService;
    
    @Autowired
    OrderItemRepository PriebesJoomlaImporterServiceTest.orderItemRepository;
    
    @Test
    public void PriebesJoomlaImporterServiceTest.testCountAllOrderItems() {
    ...
    @Test
    public void PriebesJoomlaImporterServiceTest.testFindOrderItem() {
    ...
    @Test
    public void PriebesJoomlaImporterServiceTest.testFindAllOrderItems() {
        Assert.assertNotNull("Data on demand for 'OrderItem' failed to initialize correctly", dod.getRandomOrderItem());
        long count = orderItemService.countAllOrderItems();
    ...
    @Test
    public void PriebesJoomlaImporterServiceTest.testFindOrderItemEntries() {
        Assert.assertNotNull("Data on demand for 'OrderItem' failed to initialize correctly", dod.getRandomOrderItem());
        long count = orderItemService.countAllOrderItems();
    ...
    @Test
    public void PriebesJoomlaImporterServiceTest.testFlush() {
        OrderItem obj = dod.getRandomOrderItem();
        Assert.assertNotNull("Data on demand for 'OrderItem' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'OrderItem' failed to provide an identifier", id);
    ...
    @Test
    public void PriebesJoomlaImporterServiceTest.testUpdateOrderItemUpdate() {
        OrderItem obj = dod.getRandomOrderItem();
        Assert.assertNotNull("Data on demand for 'OrderItem' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'OrderItem' failed to provide an identifier", id);
    ...
    @Test
    public void PriebesJoomlaImporterServiceTest.testSaveOrderItem() {
        Assert.assertNotNull("Data on demand for 'OrderItem' failed to initialize correctly", dod.getRandomOrderItem());
    ...
    @Test
    public void PriebesJoomlaImporterServiceTest.testDeleteOrderItem() {
        OrderItem obj = dod.getRandomOrderItem();
        Assert.assertNotNull("Data on demand for 'OrderItem' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'OrderItem' failed to provide an identifier", id);
