...
privileged aspect CategoryIntegrationTest_Roo_IntegrationTest {
    ...
    @Test
    public void CategoryIntegrationTest.testCount() {
    ...
    @Test
    public void CategoryIntegrationTest.testFind() {
    ...
    @Test
    public void CategoryIntegrationTest.testFindAll() {
        Assert.assertNotNull("Data on demand for 'Category' failed to initialize correctly", dod.getRandomCategory());
        long count = categoryRepository.count();
    ...
    @Test
    public void CategoryIntegrationTest.testFindEntries() {
        Assert.assertNotNull("Data on demand for 'Category' failed to initialize correctly", dod.getRandomCategory());
        long count = categoryRepository.count();
        if (count > 20) count = 20;
        int firstResult = 0;
        int maxResults = (int) count;
        List<Category> result = categoryRepository.findAll(new org.springframework.data.domain.PageRequest(firstResult / maxResults, maxResults)).getContent();
    ...
    @Test
    public void CategoryIntegrationTest.testSaveUpdate() {
        Category obj = dod.getRandomCategory();
        Assert.assertNotNull("Data on demand for 'Category' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Category' failed to provide an identifier", id);
    ...
    @Test
    public void CategoryIntegrationTest.testSave() {
        Assert.assertNotNull("Data on demand for 'Category' failed to initialize correctly", dod.getRandomCategory());
    ...
    @Test
    public void CategoryIntegrationTest.testDelete() {
        Category obj = dod.getRandomCategory();
        Assert.assertNotNull("Data on demand for 'Category' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Category' failed to provide an identifier", id);
        ...
        categoryRepository.flush();
        Assert.assertNull("Failed to remove 'Category' with identifier '" + id + "'", categoryRepository.findOne(id));
    }
