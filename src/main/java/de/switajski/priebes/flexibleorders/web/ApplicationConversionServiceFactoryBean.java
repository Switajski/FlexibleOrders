...
public class ApplicationConversionServiceFactoryBean extends FormattingConversionServiceFactoryBean {
    ...
    public Converter<Customer, String> getCustomerToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<de.switajski.priebes.flexibleorders.domain.Customer, java.lang.String>() {
            ...
            public String convert(Customer customer) {
                return new StringBuilder().append(customer.getCustomerNumber()).append(' ').append(customer.getFirstName()).append(' ').append(
                        customer.getLastName()).append(' ').append(customer.getInvoiceAddress().getStreet()).toString();
            }
        };
    }
    ...
    public Converter<OrderItem, String> getOrderItemToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<de.switajski.priebes.flexibleorders.domain.OrderItem, java.lang.String>() {
            ...
            public String convert(OrderItem orderItem) {
                return new StringBuilder().append(orderItem.getCreated()).append(' ').append(orderItem.getOrderedQuantity()).append(' ').append(' ').append(
                        orderItem.getProduct().getName()).toString();
            }
        };
    }
    ...
    // de.switajski.priebes.flexibleorders.domain.Product>() {
    // public de.switajski.priebes.flexibleorders.domain.Product
